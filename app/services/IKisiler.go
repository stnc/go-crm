...
type KisilerAppInterface interface {
	...
	GetKisiAciklama(id uint64, aciklamaOut *string)
	...
	SetAciklama(kisiID uint64, value string)
}
...
func (f *KisilerApp) GetKisiAciklama(id uint64, aciklamaOut *string) {
	f.request.GetKisiAciklama(id, aciklamaOut)
}
...
func (f *KisilerApp) SetAciklama(kisiID uint64, value string) {
	f.request.SetAciklama(kisiID, value)
}
