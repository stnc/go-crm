...
type Post struct {
	...
	PostTitle    string     `gorm:"type:varchar(255) ;not null;" validate:"required" json:"title" `
	PostContent  string     `gorm:"type:text ;" validate:"required"  json:"content"`
	PostExcerpt  string     `gorm:"type:text ;" json:"short_content"`
	PostPassword string     `gorm:"type:varchar(255) ;null;" json:"password"`
	PostSlug     string     `gorm:"type:varchar(255) ;null;" json:"slug"`
