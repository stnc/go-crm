...
type WebArchiveLinks struct {
	...
	Link         string     `gorm:"type:varchar(255) ;not null;" validate:"required" json:"title" `
	Pdf          string     `gorm:"type:varchar(255) ;not null;" json:"content"`
	Png          string     `gorm:"type:varchar(255) ;not null;" json:"short_content"`
