...
type Media struct {
	...
	MediaName   string     `gorm:"type:varchar(255) ;not null;" validate:"required" json:"MediaName"`
	MimeType    string     `gorm:"type:varchar(255) ;not null;" validate:"required" json:"MimeType"`
	UploadSize  string     `gorm:"type:varchar(255) ;not null;" json:"UploadSize"`
	MetaExif    string     `gorm:"type:varchar(255) ;not null;" json:"MetaExif"`
	MetaIPTC    string     `gorm:"type:varchar(255) ;not null;" json:"MetaIPTC"`
