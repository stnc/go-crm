...
var KisilerTableName string = "sacrifice_kisiler"
...
type Kisiler struct {
	...
	AdSoyad       string               `gorm:"type:varchar(255);" validate:"required,omitempty,min=2,max=50" json:"adSoyad" `
	Telefon       string               `gorm:"type:varchar(255);"  validate:"required,omitempty" json:"tel"`
	...
	Kurbanlar     []SacrificeKurbanlar `gorm:"foreignKey:KisiID;references:ID"`
}
