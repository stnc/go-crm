...
//Save data
func (r *HayvanBilgisiRepo) Save(data *entity.SacrificeHayvanBilgisi) (*entity.SacrificeHayvanBilgisi, map[string]string) {
...
//Update upate data
func (r *HayvanBilgisiRepo) Update(data *entity.SacrificeHayvanBilgisi) (*entity.SacrificeHayvanBilgisi, map[string]string) {
	dbErr := map[string]string{}
...
func (r *HayvanBilgisiRepo) Delete(id uint64) error {
	var data entity.SacrificeHayvanBilgisi
	var err error
...
//GetByID get data
func (r *HayvanBilgisiRepo) GetByID(id uint64) (*entity.SacrificeHayvanBilgisi, error) {
	var data entity.SacrificeHayvanBilgisi
	var err error
...
func (r *HayvanBilgisiRepo) GetAllFindDurum(durum int) ([]entity.SacrificeHayvanBilgisi, error) {
	var datas []entity.SacrificeHayvanBilgisi
	var err error
...
func (r *HayvanBilgisiRepo) GetAllP(perPage int, offset int) ([]entity.SacrificeHayvanBilgisi, error) {
	var datas []entity.SacrificeHayvanBilgisi
...
//LastID last id
func (r *HayvanBilgisiRepo) LastID(id uint64, lastid *uint64) {
	var iddata uint64
	row := r.db.Debug().Table(hayvanBilgisiTableName).Select("id").Where("id < ? ", id).Order("id desc").Row()
	row.Scan(&iddata)
	*lastid = iddata
}

//NextID next id
func (r *HayvanBilgisiRepo) NextID(id uint64, lastid *uint64) {
	var iddata uint64
	row := r.db.Debug().Table(hayvanBilgisiTableName).Select("id").Where("id > ? ", id).Order("id asc").Row()
	row.Scan(&iddata)
	*lastid = iddata
}
...
//GetAll all data
func (r *HayvanBilgisiRepo) GetAll() ([]entity.SacrificeHayvanBilgisi, error) {
	var hayvanBilgisi []entity.SacrificeHayvanBilgisi
	var err error
