...
//Save data
func (r *HayvanSatisYerleriRepo) Save(data *entity.SacrificeHayvanSatisYerleri) (*entity.SacrificeHayvanSatisYerleri, map[string]string) {
...
//Update upate data
func (r *HayvanSatisYerleriRepo) Update(data *entity.SacrificeHayvanSatisYerleri) (*entity.SacrificeHayvanSatisYerleri, map[string]string) {
	dbErr := map[string]string{}
...
func (r *HayvanSatisYerleriRepo) Count(dataTotalCount *int64) {
	var data entity.SacrificeHayvanSatisYerleri
	var count int64
...
//GetByID get data
func (r *HayvanSatisYerleriRepo) GetByID(id uint64) (*entity.SacrificeHayvanSatisYerleri, error) {
	var data entity.SacrificeHayvanSatisYerleri
	var err error
...
//GetAll all data
func (r *HayvanSatisYerleriRepo) GetAll() ([]entity.SacrificeHayvanSatisYerleri, error) {
	var datas []entity.SacrificeHayvanSatisYerleri
	var err error
...
func (r *HayvanSatisYerleriRepo) GetAllP(perPage int, offset int) ([]entity.SacrificeHayvanSatisYerleri, error) {
	var datas []entity.SacrificeHayvanSatisYerleri
