...
func OptionsDefault(c *gin.Context) {
	...
	user := entity.User{FirstName: "Sel", LastName: "t", Email: "hk@gmail.com", Password: "kkkk"}
	...
	adak := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "Adak Olarak Kesilecek Hayvanların Üst Grubudur, değişikliğe kapalıdır", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "adak"}
	db.Debug().Create(&adak)

	akika := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "Akika Olarak Kesilecek Hayvanların Üst Grubudur, değişikliğe kapalıdır", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "akika"}
	db.Debug().Create(&akika)

	sukur := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "Şükür Olarak Kesilecek Hayvanların Üst Grubudur, değişikliğe kapalıdır", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "sukur"}
	db.Debug().Create(&sukur)

	sahibNi := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "SAHİBİNİN NİYETİNE Olarak Kesilecek Hayvanların Üst Grubudur, değişikliğe kapalıdır", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "sahibi-niyetine"}
	db.Debug().Create(&sahibNi)

	bagis := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "BAĞIŞ Olarak Kesilecek Hayvanların Üst Grubudur, değişikliğe kapalıdır", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "hayir"}
	db.Debug().Create(&bagis)

	naf := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "NAFİLE Olarak Kesilecek Hayvanların Üst Grubudur, değişikliğe kapalıdır", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "nafile"}
	db.Debug().Create(&naf)

	sifa := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "Şifa Olarak Kesilecek Hayvanların Üst Grubudur, değişikliğe kapalıdır", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "sifa"}
	db.Debug().Create(&sifa)

	krubanBayrami := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "Kurban Bayramı Kesilecek Büyük Baş Hayvan Atanmamış Değer", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "kurbanBayramiBuyukbas"}
	db.Debug().Create(&krubanBayrami)

	krubanBayramiKucukbas := entity.SacrificeGruplar{KesimSiraNo: 0, Aciklama: "Kurban Bayramı Kesilecek Büyük Baş Hayvan Atanmamış Değer", HissedarAdet: 1, Durum: 1, KurbanBayramiYili: 2021, HayvanBilgisiID: 0, Slug: "kurbanBayramiKucukBas"}
